...
// Mock data for P&L chart (replace with actual user data)
const mockPnLData = [
  { date: "Jan", value: 100 },
  { date: "Feb", value: 120 },
  { date: "Mar", value: 110 },
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              >
                <h3 className="text-xl font-bold mb-4 text-textPrimary flex items-center gap-2">
                  <TrendingUpIcon size={24} className="text-green-500" /> Profit
                  & Loss Overview
                </h3>
                {mockPnLData.length > 0 ? (
                  <>
                    <div className="flex justify-between items-end mb-4">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-400">
                          {formatMoneyWithSelectedCurrency(
                            mockPnLData[mockPnLData.length - 1].value
                          )}
                        </p>
                      </div>
                    ...
                    <div className="w-full h-32">
                      <Sparklines
                        data={mockPnLData.map((d) => d.value)}
                        width={280}
                        height={120}
                      >
                        <SparklinesLine
                    ...
                    <p className="text-xs text-textSecondary mt-2 text-center">
                      (Mock data: Replace with actual historical P&L from your
                      trades)
                    </p>
                  </>
                ) : (
